...
ActiveRecord::Schema.define(:version => 20130308144046) do
  ...
  add_index "pages", ["subject_id"], :name => "fk_pages_subjects"
  ...
  add_index "section_edits", ["section_id"], :name => "fk_edits_sections"
  ...
  add_index "sections", ["page_id"], :name => "fk_sections_pages"
